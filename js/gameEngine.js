...
export class GameEngine {
    ...
    update(gameTime) {
        ...
        // Detectem si s'ha pres la tecla enter i activem l'acció especial
        if (KEY_STATUS.Enter) {
            this.player.specialAttack(this.getActiveEnemies());
        }
    ...
    getActiveEnemies = function() {
        let enemies = this.enemyPool.pool.slice(0, this.enemyPool.actives);
        return enemies;
    };
}
